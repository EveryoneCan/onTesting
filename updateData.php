...
$sqlOne="SELECT * FROM emp_info WHERE empId=$DATAidno";
$sqlOne_run=mysqli_query($nnConnString,$sqlOne);
if(mysqli_num_rows($sqlOne_run)>0){
    $data=mysqli_fetch_array($sqlOne_run);
    $idt=$data['emp_Salutation'];
    $cty=$data['empId'];
}
      ...
      <div class="container">
         <main>
            ...
            <div class="col-md-7 col-lg-8">
               ...
               <form class="needs-validation" action="updateDataA.php"  method="POST" novalidate>
                  <div class="row g-3">
                     <div class="col-sm-12">
                     <label for="firstName" class="form-label">ID Number </label>
              <input type="text" class="form-control" placeholder="" value="<?php echo $DATAidno; ?>"  id="vafirstName" name="vafirstName" readonly>
              ...
              <input type="text" class="form-control" placeholder="" value="<?php echo $idt; ?>" id="vaLastName" name="vaLastName" >
                           Valid salutation is required.
                        </div>
                     </div>
                     <div class="col-sm-6">
                        <label for="nNfirstName" class="form-label">First name</label>
                        <input type="text" class="form-control" placeholder="Password" id="vaPassword" name="vaPassword" value="<?php echo $cty; ?>">
                        <div class="invalid-feedback">
                     ...
                     <div class="col-sm-6">
                        ...
                        <input type="email" class="form-control" id="vaEmail" name="vaEmail" placeholder="you@example.com">
                        <div class="invalid-feedback">
                     ...
                     <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" placeholder="1234 Main St" id="vaAdress" name="vaAdress" >
                        <div class="invalid-feedback">
